      ...
      <div class="col-lg-12 col-xl-11">
        <div class="card text-black" style="border-radius: 25px;">
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
             ...
             <!-- Name Input-->
                <form class="mx-1 mx-md-4">
                  <div class="mb-4">
                    <div class="d-flex flex-arrow align-items-center">
            ...
            <!--Login Button usabonon-->
                  <div class="">
                     <a href="{{ route('login') }}" class="btn btn-secondary">Naa kay account daan? paglogin tawon diri</a>
                  </div>
                </form>
              </div>
